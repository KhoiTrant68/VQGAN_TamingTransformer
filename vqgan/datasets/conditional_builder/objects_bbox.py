...
from vqgan.datasets.image_transforms import convert_pil_to_tensor
from vqgan.datasets.helper_types import BoundingBox, Annotation
from vqgan.datasets.conditional_builder.objects_center_points import (
    ObjectsCenterPointsConditionalBuilder,
)
from vqgan.datasets.conditional_builder.utils import (
    COLOR_PALETTE,
    WHITE,
    GRAY_75,
    BLACK,
