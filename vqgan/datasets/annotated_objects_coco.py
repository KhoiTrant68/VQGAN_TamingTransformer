...
from vqgan.datasets.annotated_objects_dataset import AnnotatedObjectsDataset
from vqgan.datasets.helper_types import Annotation, ImageDescription, Category
