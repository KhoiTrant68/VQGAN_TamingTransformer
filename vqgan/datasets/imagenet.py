...
from vqgan.datasets.base import ImagePaths
from vqgan.utils import download, retrieve
from vqgan.datasets import utils as bdu
...
class ImageNetTrain(ImageNetBase):
    ...
    def _prepare(self):
        ...
        if not os.path.isfile(self.txt_filelist):
